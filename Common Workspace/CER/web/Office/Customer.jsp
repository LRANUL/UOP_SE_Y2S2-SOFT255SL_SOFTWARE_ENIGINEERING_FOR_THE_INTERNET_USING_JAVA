<%-- 
    Document   : Customer
    Created on : May 17, 2020, 12:51:28 PM
    Author     : ranul
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Customer.jsp"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                                     height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <form action="../Office/Customer" method="post">
                        Search Customer
                        <input type="text" name="CustomerName" class="form-control bg-white"
                               placeholder="Enter Customer Name">
                        <input type="text" name="CustomerEmail" class="form-control bg-white"
                               placeholder="Enter Customer Email">
                        <input type="text" name="CustomerNIC" class="form-control bg-white"
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${requestScope.users}" var="user">
                                    <tr>
                                        <td><c:out value="${user.name.prefix}"></c:out> <c:out value="${user.name.firstName}"></c:out> <c:out value="${user.name.lastName}"></c:out></td>
                                        <td><c:out value="${user.emailAddress}"></c:out></td>
                                        <td><c:out value="${user.nic}"></c:out></td>
                                            <td><form action="../Office/Customer" method="post" name="form">
                                                    <select name="Reply">
