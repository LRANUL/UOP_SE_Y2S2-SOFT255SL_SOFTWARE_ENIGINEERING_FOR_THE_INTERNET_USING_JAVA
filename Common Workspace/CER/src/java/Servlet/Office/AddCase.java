 ...
 * @author Hp-Pc
 */
@WebServlet(name = "AddCase", urlPatterns = {"/Office/AddCase"})
public class AddCase extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        String caseNo = request.getParameter("DcaseNo");
        String Clocation =  request.getParameter("DCLocation");
        String party =  request.getParameter("Dparty");
        ...
        if(caseNo != null && Clocation !=null && party != null && Date !=null)
        {
