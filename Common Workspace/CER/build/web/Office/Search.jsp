            ...
            <div class="row">
                ...
                <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" href="Dashboard.html"> <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Find Cases and Documents</h1>
                    ...
                    <div class="input-group">
                        <form name="CaseNoSearch" method="post" action="/OfficeSearch">
                            Find Document<input type="text" name="CaseNumber" class="form-control bg-white" placeholder="Case Number" >
