<%-- 
    Document   : Order
    Created on : May 16, 2020, 5:52:12 PM
    Author     : ranul
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Orders.html"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Search.html"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                             height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <form action="../Office/fetchOrder" method="post">
                        <button type="submit" name="button" value="fetch">Get Orders</button>
                    </form>
                    <hr>
